...
export interface ProductEntry {
  ...
  imageSrc?: string;
  /** Exact model description for the product image. */
  imageAlt?: string;
  /** Official manufacturer page from which the product image was sourced. */
...
export const CAPACITY_CLASSES: readonly CapacityClass[] = [
  {
    ...
    products: [
      ...
      // amzn.to/3ULg6T7 -> amazon.com/dp/B07SM5HBK1 "Jackery Explorer 500 v2 ... 512Wh, 500W AC (1000W Surge)".
      {
        ...
        imageSrc: "/products/jackery-explorer-500-v2.webp",
        imageAlt: "Jackery Explorer 500 v2 portable power station",
        imageSourceUrl: "https://uk.jackery.com/products/explorer-500-v2-portable-power-station",
      ...
      // The 1000W is X-Boost, not a rated surge -> surgeOutputW left undefined.
      {
        ...
        imageSrc: "/products/ecoflow-river-2-max-500.webp",
        imageAlt: "EcoFlow RIVER 2 Max 500 portable power station",
        imageSourceUrl: "https://manuals.ecoflow.com/us/product/river-2-max-portable-power-station?lang=en_US",
  ...
  },
  {
    ...
    products: [
      ...
      // amzn.to/4wWx2Ue -> amazon.com/dp/B0D7PPG25F. Jackery: 1070Wh, 1500W rated, 3000W surge peak, 3x 120V.
      {
        ...
        imageSrc: "/products/jackery-explorer-1000-v2.webp",
        imageAlt: "Jackery Explorer 1000 v2 portable power station",
        imageSourceUrl: "https://www.jackery.com/products/jackery-explorer-1000-v2",
      ...
      // amzn.to/4zM42RC -> amazon.com/dp/B0FQVC4RF5. EcoFlow: 1024Wh, 1800W rated, 3600W surge (X-Boost 2600W not counted).
      {
        ...
        imageSrc: "/products/ecoflow-delta-3-classic.webp?v=2",
        imageAlt: "EcoFlow DELTA 3 Classic portable power station",
        imageSourceUrl: "https://us.ecoflow.com/products/delta-3-classic-portable-power-station",
      ...
      // HyperVolt / Power Lifting, not a rated surge -> surgeOutputW left undefined.
      {
        ...
        imageSrc: "/products/bluetti-elite-100-v2.webp?v=2",
        imageAlt: "BLUETTI Elite 100 V2 portable power station",
        imageSourceUrl: "https://www.bluettipower.com/products/elite-100-v2-portable-power-station",
  ...
  },
  {
    ...
    products: [
      ...
      // amzn.to/4d7s3c4 -> amazon.com/dp/B0DFG2WDQH. Jackery: 2042Wh, 2200W rated, 4400W surge.
      {
        ...
        imageSrc: "/products/jackery-explorer-2000-v2.webp",
        imageAlt: "Jackery Explorer 2000 v2 portable power station",
        imageSourceUrl: "https://www.jackery.com/products/jackery-explorer-2000-v2-portable-power-station",
      ...
      // 3400W is X-Boost, not a rated surge -> surgeOutputW left undefined.
      {
        ...
        imageSrc: "/products/ecoflow-delta-3-max.webp",
        imageAlt: "EcoFlow DELTA 3 Max portable power station",
        imageSourceUrl: "https://www.ecoflow.com/us/delta-3-series",
      ...
      // 3600W is not a rated surge -> surgeOutputW left undefined.
      {
        ...
        imageSrc: "/products/bluetti-ac200l.webp",
        imageAlt: "BLUETTI AC200L portable power station",
        imageSourceUrl: "https://www.bluettipower.com/products/ac200l",
  ...
  },
  {
    ...
    products: [
      ...
      // amzn.to/3UulYA8 -> amazon.com/dp/B0FFSLG3WZ "Jackery HomePower 3000 ... 3072Wh, 3600W AC Output | 7200W Surge".
      {
        ...
        imageSrc: "/products/jackery-homepower-3000.webp",
        imageAlt: "Jackery HomePower 3000 portable power station",
        imageSourceUrl: "https://www.jackery.com/products/jackery-homepower-3000",
      ...
      // amzn.to/3SCc7Yk -> amazon.com/dp/B0FQVBFLHL "EcoFlow Delta 3 Ultra ... 3072Wh ... 3600W (Surge 7200W) Output".
      {
        ...
        imageSrc: "/products/ecoflow-delta-3-ultra.webp",
        imageAlt: "EcoFlow DELTA 3 Ultra portable power station",
        imageSourceUrl: "https://us.ecoflow.com/products/ecoflow-delta-3-ultra-portable-power-station-3072wh",
      ...
      // figure is not a rated surge -> surgeOutputW left undefined.
      {
        ...
        imageSrc: "/products/bluetti-elite-300.webp?v=2",
        imageAlt: "BLUETTI Elite 300 portable power station",
        imageSourceUrl: "https://www.bluettipower.com/products/elite-300-portable-power-station",
