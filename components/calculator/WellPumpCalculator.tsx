    ...
    <>
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-2">
                <label className="block text-sm">
                  ...
                  <input
                    ...
                    aria-label="Well pump running watts"
                ...
                <label className="block text-sm">
                  ...
                  <input
                    ...
                    aria-label="Well pump startup or surge watts"
          ...
          <div className="space-y-4 lg:sticky lg:top-6">
            ...
            <div className="rounded-2xl border border-line bg-white p-5 sm:p-6">
              ...
              {!surgeKnown && (
                <p className="mt-3 rounded-lg border border-amber-200 bg-amber-50/70 p-3 text-xs leading-relaxed text-amber-800">
                  ...
                  its manual, or the pump / controller manufacturer&apos;s documentation before
                  choosing a power station. A unit with plenty of battery capacity can still fail to
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50/70 p-5 sm:p-6">
              ...
              <div className="mt-2 space-y-2 text-xs leading-relaxed text-amber-800">
                <p>Check whether your well pump is a 120V or 240V unit before buying anything.</p>
                <ul className="list-disc space-y-1 pl-5">
                  <li>Many portable power stations provide 120V AC only.</li>
                  <li>
                    A 240V well pump cannot be powered directly by a 120V-only power station, no
                    matter how large its battery is.
                  </li>
                  <li>
                    Verify voltage, outlet / output configuration, continuous watts, and startup
                    surge before buying.
                  </li>
                </ul>
                <p>
                  This calculator sizes energy (Wh) and reports the output (W) you need. It does not
                  check 120V versus 240V compatibility &mdash; enough watt-hours does not mean a 240V
                  pump will run.
                </p>
              </div>
            </div>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-14 sm:px-6">
        <p className="mx-auto max-w-3xl text-xs leading-relaxed text-ink/55">
          ...
          &mdash; capacity class alone does not confirm that a unit can start and run your well pump.
        </p>
      </section>
    </>
  );
