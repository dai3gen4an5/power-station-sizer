...
export function EbWorkedExample() {
  ...
  // 3. final output-aware recommendation range — after the AC-output check
  ...
  return (
    <div>
      <h2 className="h2">75&nbsp;W, 8-hour worked example</h2>
      <p className="mt-3 text-ink/75">
        A single electric blanket drawing {WATTS}&nbsp;W, run for a full {HOURS}-hour night. This is
        the calculator&apos;s default example. Use your own numbers.
      </p>
      <div className="mt-4 card card-pad">
        ...
        <p className="mt-3 text-sm text-ink/75">
          ...
          <span className="font-mono">{WATTS} W</span> continuously, far below what any listed unit
          can supply.{" "}
          {escalated ? (
            <>
            ...
            <>
              ...
              &mdash; the eight hours of runtime, not the 75&nbsp;W, are what put it there.
            </>
          )}{" "}
