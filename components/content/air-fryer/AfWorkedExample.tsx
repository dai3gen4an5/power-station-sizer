...
export function AfWorkedExample() {
  ...
  return (
    <div>
      <h2 className="h2">1,500&nbsp;W, 20-minute worked example</h2>
      <p className="mt-3 text-ink/75">
        A {WATTS.toLocaleString("en-US")}&nbsp;W air fryer run for {MINUTES} minutes. Example figures
        &mdash; use your own air fryer&apos;s label wattage and cook time.
      </p>
