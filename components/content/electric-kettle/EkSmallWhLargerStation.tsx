...
export function EkSmallWhLargerStation() {
  return (
    <div>
      <h2 className="h2">Why a small Wh requirement can still need a larger power station</h2>
      <div className="mt-3 space-y-3 text-ink/75">
        <p>
          A kettle is only on for a few minutes, so it barely touches the battery. But for those
