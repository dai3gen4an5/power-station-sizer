...
export function EkWorkedExample() {
  ...
  return (
    <div>
      <h2 className="h2">1,500&nbsp;W, 5-minute worked example</h2>
      <p className="mt-3 text-ink/75">
        A {WATTS.toLocaleString("en-US")}&nbsp;W kettle run for {MINUTES} minutes. Example figures
        &mdash; use your own kettle&apos;s label wattage and run time.
      </p>
