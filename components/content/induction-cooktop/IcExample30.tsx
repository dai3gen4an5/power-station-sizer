...
export function IcExample30() {
  ...
  return (
    <div>
      <h2 className="h2">1,800&nbsp;W, 30-minute example</h2>
      <p className="mt-3 text-ink/75">
        The same {WATTS.toLocaleString("en-US")}&nbsp;W cooktop, now run for {MINUTES} minutes
        &mdash; a full meal rather than a quick boil. Example figures; use your own numbers.
      </p>
      <div className="mt-4 card card-pad">
        ...
        <p className="mt-3 text-sm text-ink/75">
          Doubling the cook time doubles the raw energy to {formatWh(rawWh)}. After{" "}
          ...
          from the 15-minute case, because the longer cook pushes the capacity requirement itself
          higher.
        </p>
        <p className="mt-3 text-sm text-ink/75">
          ...
          the cooktop&apos;s watts, not the cook time.{" "}
          {escalated ? (
            <>
          ...
          The takeaway: at 15 minutes the output rating is the binding constraint; by 30 minutes the
